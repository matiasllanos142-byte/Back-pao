...
CHECKOUT_RETURN_TOKEN_TTL_SECONDS = int(
    os.environ.get("CHECKOUT_RETURN_TOKEN_TTL_SECONDS", str(60 * 60 * 24 * 30))
)
...
EMAIL_ACCESS_CODE_RESEND_COOLDOWN_SECONDS = int(
    os.environ.get("EMAIL_ACCESS_CODE_RESEND_COOLDOWN_SECONDS", "30")
)
