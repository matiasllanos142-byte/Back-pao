...
def _base_html(content_html, hero_url, preheader=""):
    ...
    return (
        ...
        f'<p style="margin:4px 0 0;color:rgba(255,255,255,0.85);font-family:Helvetica,Arial,sans-serif;font-size:13px;">Psicopedagogía infantil</p>\n'
        f'</td></tr></table>\n'
        f'</td></tr>\n'
        f'{hero_section}\n'
        ...
        f'<table role="presentation" width="100%" cellpadding="0" cellspacing="0">\n'
        f'<tr><td style="text-align:center;">\n'
        f'<p style="margin:0 0 4px;color:#64748b;font-family:Helvetica,Arial,sans-serif;font-size:13px;">Paola Psicopé &mdash; Psicopedagogía infantil</p>\n'
